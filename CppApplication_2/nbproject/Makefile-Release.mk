...
.NO_PARALLEL:${OBJECTDIR}/thematic\ 5.1.o
${OBJECTDIR}/thematic\ 5.1.o: thematic\ 5.1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thematic\ 5.1.o thematic\ 5.1.c
