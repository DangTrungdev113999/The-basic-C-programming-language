...
${OBJECTDIR}/c.5.1.o: c.5.1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c.5.1.o c.5.1.c

${OBJECTDIR}/c.5.2.o: c.5.2.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c.5.2.o c.5.2.c

${OBJECTDIR}/c.5.3.o: c.5.3.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c.5.3.o c.5.3.c

${OBJECTDIR}/c.5.4.o: c.5.4.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c.5.4.o c.5.4.c

${OBJECTDIR}/c.5.5.o: c.5.5.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c.5.5.o c.5.5.c

${OBJECTDIR}/c.5.6.o: c.5.6.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c.5.6.o c.5.6.c
